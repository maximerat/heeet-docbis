...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getRequestHost, getRequestProtocol, getQuery as getQuery$1, setHeader, readBody, getRouterParam, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, sendError, getResponseStatusText, H3Error } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/@vue/shared/dist/shared.cjs.js';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/defu/dist/defu.mjs';
import { html as html$1 } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/satori-html/dist/index.js';
import sizeOf from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/image-size/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, withBase, joinRelativeURL, withoutTrailingSlash, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutLeadingSlash } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/ufo/dist/index.mjs';
import consola, { consola as consola$1, createConsola } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/consola/dist/index.mjs';
import { Launcher } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/chrome-launcher/dist/index.js';
import playwrightCore from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/playwright-core/index.mjs';
import { isVNode, toValue, isRef } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/vue/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr, { destr as destr$1 } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/destr/dist/index.mjs';
import { stringify, parse, uneval } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/devalue/index.js';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/unhead/dist/server.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/unstorage/dist/index.mjs';
import lruCacheDriver from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/unstorage/drivers/lru-cache.mjs';
import { createHooks } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/node-mock-http/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/klona/dist/index.mjs';
import { snakeCase, pascalCase } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import { ErrorParser } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/errx/dist/index.js';
import { toHast } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/minimark/dist/hast.mjs';
import devalue from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { basename, isAbsolute } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Users/maximerat/Documents/GitHub/docs/.nuxt/nuxt-icon-server-bundle.mjs';
import { renderToString } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/ipx/dist/index.mjs';
import { createGenerator } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/@unocss/preset-wind3/dist/index.mjs';
import { createUnhead } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/unhead/dist/index.mjs';
import { Resvg } from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file:///Users/maximerat/Documents/GitHub/docs/node_modules/satori/dist/index.js';

const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/Users/maximerat/Documents/GitHub/docs/.nuxt/cache/nuxt-og-image/_fonts"},{"baseName":"server","dir":"/Users/maximerat/Documents/GitHub/docs/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/maximerat/Documents/GitHub/docs","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/maximerat/Documents/GitHub/docs/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/maximerat/Documents/GitHub/docs/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/maximerat/Documents/GitHub/docs/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/maximerat/Documents/GitHub/docs/.data/kv"}));
...
const appConfig0 = defineAppConfig({
  ...
  footer: {
    credits: `Copyright \xA9 ${(/* @__PURE__ */ new Date()).getFullYear()}`,
    colorMode: false,
    links: []
  },
  toc: {
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/maximerat/Documents/GitHub/docs/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "llms": {
        ...
        "links": [
          {
            ...
            "href": "https://docs.heeet.io//llms-full.txt"
          }
        ]
      },
      {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/maximerat/Documents/GitHub/docs/public"
      ]
    },
    "http": {
      "domains": []
...
const _2B4DfGb8hpJn6eM1r0wDmKB3FFBcflWuEsmxk0TLfzQ = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/maximerat/Documents/GitHub/docs";
...
const _a3wt76LKj62cJjdys2lMQvpgj_Z354qrUXaqwDZqCW8 = (nitroApp) => {
...
const _Q_UrB8YOEg13xi2SCzIYkAoqCKbJRFeV1cfivButvs = defineNitroPlugin((nitroApp) => {
...
const _FAvMCx1l1XKdoWX8TlYVMo3N493BQ6p19hdeRXaHF4 = defineNitroPlugin(async (nitroApp) => {
...
const componentNames = [{"hash":"3WjFQtL4Ww14dJT-vzC-pgljVikKE-id0CV-AECyrxo","pascalName":"OgImageDocs","kebabName":"og-image-docs","path":"/Users/maximerat/Documents/GitHub/docs/app/components/OgImage/OgImageDocs.vue","category":"app"},{"hash":"SOHaoKfoo4fUkREsCFGw8ewxkl4-XkkHkug2VwYRtFM","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/Users/maximerat/Documents/GitHub/docs/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue","category":"community"},{"hash":"tFoYPh0fXaZR3uXybAqFEOGnQuQsvz-E-Yq-CtrFlIY","pascalName":"Frame","kebabName":"frame","path":"/Users/maximerat/Documents/GitHub/docs/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue","category":"community"},{"hash":"NPQTTXYQ8toXx5OaJ1VlRUUcxy1SNOxg-FoM7C08ZPM","pascalName":"Nuxt","kebabName":"nuxt","path":"/Users/maximerat/Documents/GitHub/docs/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue","category":"community"},{"hash":"VAHSTZlVcPHzkozocV1iTnwc4-YttdoOkHsYfoSgDZ4","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/Users/maximerat/Documents/GitHub/docs/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue","category":"community"},{"hash":"8CNn4yU043gQFqO-sZNDPz9GKED-h7ahXJ-61c9ThHM","pascalName":"Pergel","kebabName":"pergel","path":"/Users/maximerat/Documents/GitHub/docs/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue","category":"community"},{"hash":"b-Juo-FXQepo6SOCnA478MTAqbXNZuve6-MzHgTKA7s","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/Users/maximerat/Documents/GitHub/docs/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue","category":"community"},{"hash":"vRUm5ru-64PEHIGsBby6-vCgLBg7iUJfvFKL6VuCXtI","pascalName":"UnJs","kebabName":"un-js","path":"/Users/maximerat/Documents/GitHub/docs/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue","category":"community"},{"hash":"hq07GBU-Yd16ICfETt8SfSxfaYj3qBmDAiQkTcv89nw","pascalName":"Wave","kebabName":"wave","path":"/Users/maximerat/Documents/GitHub/docs/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue","category":"community"},{"hash":"zSwOodBXcjwS1qvFqGBJqitTEEnrvVfwQYkTeIxNpws","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/Users/maximerat/Documents/GitHub/docs/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue","category":"community"}];
...
const _z3RkkqT1AnO11vzEJt93cOjJFrA8zTJjnfWbBpJO4 = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _j4w2PN9llQl9M9Oy55f0mFnFRLXeJfGwivAx5rfS_YY = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _2B4DfGb8hpJn6eM1r0wDmKB3FFBcflWuEsmxk0TLfzQ,
_a3wt76LKj62cJjdys2lMQvpgj_Z354qrUXaqwDZqCW8,
_Q_UrB8YOEg13xi2SCzIYkAoqCKbJRFeV1cfivButvs,
_FAvMCx1l1XKdoWX8TlYVMo3N493BQ6p19hdeRXaHF4,
_z3RkkqT1AnO11vzEJt93cOjJFrA8zTJjnfWbBpJO4,
_j4w2PN9llQl9M9Oy55f0mFnFRLXeJfGwivAx5rfS_YY
];

const warnOnceSet = /* @__PURE__ */ new Set();
const DEFAULT_ENDPOINT = "https://api.iconify.design";
const _dF03hF = defineCachedEventHandler(async (event) => {
...
const _XL1F6u = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _cFUPlw = eventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _MaEOp7 = eventHandler(async (event) => {
...
const _JpKww7 = eventHandler(async (event) => {
  const options = useRuntimeConfig(event).llms;
  const contents = [];
  const llms = JSON.parse(JSON.stringify(options));
...
const getServerEntry = () => import('file:///Users/maximerat/Documents/GitHub/docs/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/maximerat/Documents/GitHub/docs/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _65D22V = eventHandler(async (event) => {
  ...
  return await import('file:///Users/maximerat/Documents/GitHub/docs/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _B5tJHt = eventHandler(async (event) => {
...
const _Qqx6vc = lazyEventHandler(() => {
...
const _lazy_F86tzQ = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_wjvsAD = () => Promise.resolve().then(function () { return font$1; });
const _lazy_hUeugP = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_yBHHLw = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_F86tzQ, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _dF03hF, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_wjvsAD, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _XL1F6u, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _cFUPlw, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_hUeugP, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_yBHHLw, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_yBHHLw, lazy: true, middleware: false, method: undefined },
  { route: '/llms.txt', handler: _MaEOp7, lazy: false, middleware: false, method: "get" },
  { route: '/llms-full.txt', handler: _JpKww7, lazy: false, middleware: false, method: "get" },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _65D22V, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _B5tJHt, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _Qqx6vc, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_F86tzQ, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_F86tzQ, lazy: true, middleware: false, method: undefined }
];
